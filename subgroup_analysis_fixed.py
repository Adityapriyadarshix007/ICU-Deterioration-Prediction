...
# Create simulated subgroups (in practice, from actual patient data)
np.random.seed(42)
subgroups = {
...
results_df.to_csv('outputs/tables/subgroup_analysis_fixed.csv', index=False)
print("\n✅ Results saved: outputs/tables/subgroup_analysis_fixed.csv")
